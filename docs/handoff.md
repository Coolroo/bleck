...
⚠️ **`Notes_Super Paper Mario - The Cutting Room Floor.html`** sits at the repo
root — a 121 KB browser-saved TCRF page, committed to settle the D41 injection
question. It is third-party content under TCRF's licence and is not referenced
by any code. Worth relocating under `docs/` with a provenance note, or dropping
now that D41 and D42 have extracted what it was worth.
