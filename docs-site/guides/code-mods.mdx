...
<Warning>
**Not yet integrated into the CLI.** The toolchain is proven — `bleck` can build
a valid REL module — but compiling code as part of a mod is not implemented.
This page documents what works today and what is coming.
</Warning>
