...
The site is Mintlify, built with [bun](https://bun.sh/). Full install options are
in [bun's documentation](https://bun.sh/docs/installation).
...
<Tabs>
  ...
  <Tab title="Windows">
    ...
    Or `winget install --id Oven-sh.Bun -e`.
  </Tab>
</Tabs>
